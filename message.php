          ...
          <div class="container border m-3 d-flex justify-content-center">
            <div class="row d-flex">
              <div class="col-12 d-flex">
                <form action="" class="justify-content-center text-center p-3">
                  <div class="form-group">
                    <label class="form-label justify-content-center mt-3"
                      >Login</label
                    >
...
<!-- PARTIE MESSAGE POST -->
          <div class="container border m-3 p-3 d-flex justify-content-center">
            <div class="row d-flex">
